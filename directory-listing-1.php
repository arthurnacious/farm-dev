<?php
	...
	curl_setopt_array($curl6, array(
	   CURLOPT_URL => "https://veldtoe.co.za/dev/api.php/records/profiles/1",
	   ...
	   CURLOPT_CUSTOMREQUEST => "GET",
		//CURLOPT_POSTFIELDS => $datastring6,
	  //  CURLOPT_POSTFIELDS => $datajson6,
                ...
                <div class="container pb-2 pt-2">
                    <div class="gx-lg-5 gy-4 row">
                            ...
                            <div class="bg-light p-4 position-sticky top-0">
                                ...
                                <form> 
                                    <div class="input-group mb-3">
                                        <input type="text" class="border-end-0 form-control p-3" placeholder="Looking for?" aria-label="Enter Keyword" aria-describedby="keyword-input"><span class="bg-white input-group-text pe-3 ps-3" id="keyword-input"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
                                                <g>
                                                    <path fill="none" d="M0 0h24v24H0z"></path>
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" class="border-end-0 form-control p-3" placeholder="Location" aria-label="Enter Location" aria-describedby="location-input"><span class="bg-white input-group-text pe-3 ps-3" id="location-input"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em">
                                                <path fill="none" d="M0 0h24v24H0z"/>
                                    ...
                                    <div class="mb-3">
                                        <select class="form-select p-3" id="searchCategory" required>
                                    ...
                                    <div class="gy-2 mb-3 row row-cols-sm-2">
                                        <div>
                                            <div class="form-check">
                                                ...
                                                <label class="form-check-label" for="exampleCheck1">ATM on-site</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck2" required/>
                                                <label class="form-check-label" for="exampleCheck2">Free Wi-Fi</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck3" required/>
                                                <label class="form-check-label" for="exampleCheck3">Housekeeping</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck4" required/>
                                                <label class="form-check-label" for="exampleCheck4">Fitness Center</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck5" required/>
                                                <label class="form-check-label" for="exampleCheck5">Cable TV</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck6" required/>
                                                <label class="form-check-label" for="exampleCheck6">Air Conditioned</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck7" required/>
                                                <label class="form-check-label" for="exampleCheck7">Gift Shop</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck8" required/>
                                                <label class="form-check-label" for="exampleCheck8">Meeting Hall</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck9" required/>
                                                <label class="form-check-label" for="exampleCheck9">Pet Allowed</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck10" required/>
                                                <label class="form-check-label" for="exampleCheck10">Outdoor Pool</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck11" required/>
                                                <label class="form-check-label" for="exampleCheck11">Free Parking</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck12" required/>
                                                <label class="form-check-label" for="exampleCheck12">Bar/Lounge</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck13" required/>
                                                <label class="form-check-label" for="exampleCheck13">Terrace/Patio</label>
                                            </div>                                             
                                        </div>
                                        <div>
                                            <div class="form-check">
                                                <input type="checkbox" class="form-check-input" id="exampleCheck14" required/>
                                                <label class="form-check-label" for="exampleCheck14">Restaurant</label>
                                            </div>                                             
                                        </div>
                                    </div>                                     
                                    <div class="text-end">
                                        <button type="submit" class="btn btn-primary pe-4 ps-4 rounded-pill"><span>Filter Result</span>
                                        </button>
                                    </div>                                     
                                </form>
                            </div>                             
                        ...
                        <div class="col-lg-7 col-xl-8 order-lg-0"> 
                            ...
                            <div class="justify-content-center row row-cols-md-2"> 
                                    ...
                                    <div class="border"> <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDY5fHxhbyUyMG5hbmd8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" class="img-fluid w-100" alt="Location image" width="350" height="240"></a>
                                        <div class="pb-3 ps-4 pe-4 pt-4">
                                            <div class="align-items-center d-flex justify-content-between">
                                                <div class="pb-1 pt-1"><a href="#" class="link-dark text-decoration-none"><h2 class="h5 mb-1">(Panan Krabi) <?php echo $response_array["name"].' '.$response_array["surname"]; ?> Resort</h2></a>
                                                    <div>
                                                        ...
                                                        </svg><span class="align-middle">Ao Nang, Thailand</span>
                                                    </div>
                                                </div>
                                            ...
                                            <hr/>
                                            <div class="align-items-center d-flex justify-content-between">
                                                <div class="pb-1 pt-1"><span class="me-1 text-primary"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.125em" height="1.125em">
                                                            <g>
                                                                <path fill="none" d="M0 0h24v24H0z"/>
                                                        ...
                                                        </svg></span><span class="align-middle">432 reviews</span>
                                ...
                                <div class="pb-3 pt-3"> 
                                    <div class="border"> <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1596178065887-1198b6148b2b?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDkxfHxjaGljYWdvJTIwaG90ZWx8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" class="img-fluid w-100" alt="Location image" width="350" height="240"></a>
                                        <div class="pb-3 ps-4 pe-4 pt-4">
                                            <div class="align-items-center d-flex justify-content-between">
                                                <div class="pb-1 pt-1"><a href="#" class="link-dark text-decoration-none"><h2 class="h5 mb-1">Holiday Inn Rotorua</h2></a>
                                                    <div>
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.125em" height="1.125em" class="me-1 text-primary">
                                                            <g>
                                                                <path fill="none" d="M0 0h24v24H0z"/>
                                                        ...
                                                        </svg><span class="align-middle">Rotorua, New Zealand</span>
                                                    </div>
                                                </div>
                                                <a class="btn btn-primary ms-2 p-2 rounded-pill" href="#" aria-label="add to favorite"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" class="d-block">
                                                        <g>
                                ...
                                <div class="pb-3 pt-3"> 
                                    <div class="border"> <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1548588627-f978862b85e1?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDY5fHxhbm5hcHVybmElMjBiYXNlJTIwY2FtcHxlbnwwfHx8&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" class="img-fluid w-100" alt="Location image" width="350" height="240"></a>
                                        <div class="pb-3 ps-4 pe-4 pt-4">
                                            <div class="align-items-center d-flex justify-content-between">
                                                <div class="pb-1 pt-1"><a href="#" class="link-dark text-decoration-none"><h2 class="h5 mb-1">Annpurna Base Camp</h2></a>
                                                    <div>
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.125em" height="1.125em" class="me-1 text-primary">
                                                            <g>
                                                                <path fill="none" d="M0 0h24v24H0z"/>
                                                        ...
                                                        </svg><span class="align-middle">Ghandruk, Nepal</span>
                                                    </div>
                                                </div>
                                                <a class="btn btn-primary ms-2 p-2 rounded-pill" href="#" aria-label="add to favorite"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" class="d-block">
                                                        <g>
                                ...
                                <div class="pb-3 pt-3"> 
                                    <div class="border"> <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1569369926169-9ee7fb80adeb?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDMwfHxldmVyZXN0JTIwaG90ZWx8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" class="img-fluid w-100" alt="Location image" width="350" height="240"></a>
                                        <div class="pb-3 ps-4 pe-4 pt-4">
                                            <div class="align-items-center d-flex justify-content-between">
                                                <div class="pb-1 pt-1"><a href="#" class="link-dark text-decoration-none"><h2 class="h5 mb-1">The Whitehall Hotel</h2></a>
                                                    <div>
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.125em" height="1.125em" class="me-1 text-primary">
                                                            <g>
                                                                <path fill="none" d="M0 0h24v24H0z"/>
                                                        ...
                                                        </svg><span class="align-middle">East Delaware, Chicago</span>
                                                    </div>
                                                </div>
                                                <a class="btn btn-primary ms-2 p-2 rounded-pill" href="#" aria-label="add to favorite"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" class="d-block">
                                                        <g>
                                ...
                                <div class="pb-3 pt-3"> 
                                    <div class="border"> <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1590401939533-2e990cbce326?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDQ3fHxUYW5haCUyMExvdCUyMFRlbXBsZSwlMjBiYWxpfGVufDB8fHw&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" class="img-fluid w-100" alt="Location image" width="350" height="240"></a>
                                        <div class="pb-3 ps-4 pe-4 pt-4">
                                            <div class="align-items-center d-flex justify-content-between">
                                                <div class="pb-1 pt-1"><a href="#" class="link-dark text-decoration-none"><h2 class="h5 mb-1">Tanah Lot Temple</h2></a>
                                                    <div>
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.125em" height="1.125em" class="me-1 text-primary">
                                                            <g>
                                                                <path fill="none" d="M0 0h24v24H0z"/>
                                                        ...
                                                        </svg><span class="align-middle">Beraban, Kediri, Bali</span>
                                                    </div>
                                                </div>
                                                <a class="btn btn-primary ms-2 p-2 rounded-pill" href="#" aria-label="add to favorite"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" class="d-block">
                                                        <g>
                                ...
                                <div class="pb-3 pt-3"> 
                                    <div class="border"> <a href="#" class="d-block"><img src="https://images.unsplash.com/photo-1605825831039-8b6b4199b04a?ixid=MXwyMDkyMnwwfDF8c2VhcmNofDI3fHxldmVyZXN0JTIwaG90ZWx8ZW58MHx8fA&ixlib=rb-1.2.1q=85&fm=jpg&crop=faces&cs=srgb&w=350&h=240&fit=crop" class="img-fluid w-100" alt="Location image" width="350" height="240"></a>
                                        <div class="pb-3 ps-4 pe-4 pt-4">
                                            <div class="align-items-center d-flex justify-content-between">
                                                <div class="pb-1 pt-1"><a href="#" class="link-dark text-decoration-none"><h2 class="h5 mb-1">Hotel Abbazia</h2></a>
                                                    <div>
                                                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.125em" height="1.125em" class="me-1 text-primary">
                                                            <g>
                                                                <path fill="none" d="M0 0h24v24H0z"/>
                                                        ...
                                                        </svg><span class="align-middle">Venice, Italy</span>
                                                    </div>
                                                </div>
                                                <a class="btn btn-primary ms-2 p-2 rounded-pill" href="#" aria-label="add to favorite"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1em" height="1em" class="d-block">
                                                        <g>
                            ...
                            <div class="pb-3 pt-3 text-center"><a class="align-items-center btn btn-primary d-inline-flex pe-3 ps-3 rounded-pill" href="#"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" width="1.25em" height="1.25em" class="me-2">
                                        <path fill="none" d="M0 0h24v24H0z"/>
