                    ...
                    <div class="gx-lg-5 gy-4 row">
                        <div class="col-lg-12 col-xl-12 order-lg-0"> 
                            ...
                            <div class="accordion" id="accordionExample">
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <form>
                                                <div class="mb-3">
                                                    <label for="from" class="col-form-label-lg form-label">Click on the button to search for your farm</label>
                                                    <label for="t" class="form-label">
                                                        <button type="submit" class="btn btn-lg form-submit ms-4 pe-4 ps-4 rounded-pill" data-bs-toggle="modal" data-bs-target="#exampleModal">
                                                            ...
                                                            </svg><span class="align-middle">Search</span>&nbsp;&nbsp;
                                                        </button>
                                                    </label>                                                     
                                                </div>
                                                <div class="mb-3">
                                                ...
                                                <div class="input-group mb-3">
                                                    <div class="input-group-prepend">
                                                        <label class="input-group-text" for="inputGroupSelect01">Select your province:</label>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-8 col-xl-12" style='border: 1px solid red '>
                                                        <div class="leaflet-map" id="map"></div>
                                                        <!--<div id="map"></div>-->
                                                        <!--<div id="feature-info" class="info"></div>                                                        -->
                                                        <!--<script src="assets/js/leaflet.js"></script>-->
                                                            <!-- Leaflet JS -->
                                                            <script src="https://unpkg.com/leaflet@1.7.1/dist/leaflet.js"></script>
                                                             <script src="assets/js/leafletajax/dist/leaflet.ajax.min.js"></script>
                                                                <script>
                                                                    // // Initialize the map
                                                                    var map = L.map('map').setView([-29.0789923, 24.5010161], 6);
                                                                    ...
                                                                    // Load GeoJSON file
                                                                    var geojsonLayer = L.geoJSON.ajax('data/sa_farmportions.geojson', {
                                                                    ...
                                                                    function displayFeatureInfo(feature) {
                                                                        ...
                                                                        var infoContent = '<h4>' + properties.FARMNAME + '</h4>';
                                                                        
                                                                        // Add more properties as needed
                                                                        // infoContent += '<p>Province: ' + properties.PROVINCE + '<br>' +
                                                                        // 'Farm Name: ' + properties.FARMNAME + '<br>' +
                                                                        // 'Farm Number: ' + properties.FARM_NO + '<br>' +
                                                                        // 'Farm Portion: ' + properties.PORTION + '</p>' +
                                                                        // 'Farm Area (m2): ' + properties.AreaI2 + '</p>';
                                                                        
                                                                        var farm_number_portion = properties.FARM_NO;
                                                                        if(properties.PORTION.lenth > 0){ farm_number_portion += '_' + properties.PORTION; 1}
                                                                        // Display the information in a Bootstrap modal (optional)
                                                                        document.getElementById('feature-info').innerHTML = properties.FARMNAME;
                                                                        $('#farmname').modal('show');

                                                                        document.getElementById('feature-info').innerHTML = properties.FARM_NO;
                                                                        $('#farmnumber').modal('show');

                                                                        document.getElementById('feature-info').innerHTML = properties.AreaI2;
                                                                        $('#farmsize').modal('show');
                                                                    }
                                                                </script>

                
                                                            <!-- Optional: Bootstrap JS (for modal) -->
                                    ...
                                    <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                        <div class="accordion-body">
                                            <form>
                                                ...
                                                <div class="mb-3">
                                                    <label for="accommdesc_eng" class="form-label"></label>
                                                    <textarea class="form-control" id="accommdesc_eng" rows="10" placeholder="Farm and accommodation description"></textarea>
                                                </div>
                                                <div class="mb-3">
                                                    <label for="accommdesc_afr" class="form-label"></label>
                                                    <textarea class="form-control" id="accommdesc_afr" rows="10" placeholder="Plaas en verblyf beskrywing (Opsioneel)"></textarea>
                                                </div>
                                            </form>                                             
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                <select id="accommodation_option" class="form-select" aria-label="Default select example">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingThree"> <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">Step 3 - Tell us about the services offered</button> </h2>
                                ...
                                <div class="accordion-item">
                                    ...
                                    <div id="collapseFour" class="accordion-collapse collapse" aria-labelledby="headingFour" data-bs-parent="#accordionExample" "">
                                        <div class="accordion-body">
                                            <form>
                                                <div class="mb-3">
                                                    <label for="animal_options"></label>
                                                    <select id="animal_options" class="form-select" aria-label="Default select example">
                                        ...
                                        <form>
                                            <div class="row">
                                                <div class="align-items-center col-md-5 col-xl-6 mb-3">
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="accommodation_photos" class="form-label">You can select multiple photos and load them at once</label>
                                                        <input class="form-control" type="file" id="accommodation_photos" multiple>
                                                    </div>
                                                    <label for="numberguest" class="form-label"></label>
                                                </div>
...
(min-width: 1400px) 606px" width="120" height="Auto">
                                ...
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingSix"> <button class="accordion-button collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                            Step 6 - Throw in some extras
</button> </h2>
                                </div>
                                        ...
                                        <form>
                                            <div class="row">
                                                <div class="align-items-center col-md-5 col-xl-4 mb-3">
                                                    <h5>Gun Hire</h5>
                                                    <label for="gunhire" class="form-label"></label>
                                                    <input class="form-control" id="gunhire" placeholder="Price in ZAR">
                                                </div>
                                                <div class="col-md-5 col-xl-4 mb-3">
                                                    <h5>Bakkie Hire</h5>
                                                    <label for="bakkiehire" class="form-label"></label>
                                                    <input class="form-control" id="bakkiehire" placeholder="Price in ZAR">
                                                </div>
                                                <div class="col-md-5 col-xl-4 mb-3">
                                                    <h5>Bow Hire</h5>
                                                    <label for="bowhire" class="form-label"></label>
                                                    <input class="form-control" id="bowhire" placeholder="Price in ZAR">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="align-items-center col-md-5 col-xl-4 mb-3">
                                                    <h5>Cook</h5>
                                                    <label for="cook" class="form-label"></label>
                                                    <input class="form-control" id="cook" placeholder="Price in ZAR">
                                                </div>
                                                <div class="col-md-5 col-xl-4 mb-3">
                                                    <h5>Professional Hunter (PH)</h5>
                                                    <label for="prohunter" class="form-label"></label>
                                                    <input class="form-control" id="prohunter" placeholder="Price in ZAR">
                                                </div>
                                            </div>                                             
                                        </form>
                                        <div class="row">
                        ...
                        <div class="modal-body p-5 pt-0">
                            <form class="">
                                <div class="form-floating mb-3 signin-fields">
                                    <input type="email" class="form-control rounded-4" id="useremail" placeholder="name@example.com" required>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content rounded-5 shadow">
                        ...
                        <div class="modal-body p-5 pt-0">
                            <form class="">
                                <div class="form-floating mb-3 signin-fields">
                                    <input type="email" class="form-control rounded-4" id="email2" placeholder="name@example.com" required>
                                    <label for="email2">Email address</label>
                                </div>
                                <div class="form-floating mb-3 signin-fields">
                                    <input type="password" class="form-control rounded-4" id="password2" placeholder="Password" required>
