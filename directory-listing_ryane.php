                ...
                <div class="border">
                    ...
                    <div class="pb-3 ps-4 pe-4 pt-4">
                        <div class="align-items-center d-flex justify-content-between">
                            <div class="pb-1 pt-1">
                                <a href="/directory-details.php?farm=' . escape_and_echo($item['farm_id']) . '" class="link-dark text-decoration-none"><h2 class="h5 mb-1">' . escape_and_echo($item['farm_name']) . '</h2></a>
                                <div>
                                    ...
                                    <span class="align-middle">' . escape_and_echo($item['district']) . '</span>
                                </div>
                            </div>
                            <a class="btn fav ms-2 p-2 rounded-pill" href="/directory-details.php?farm=' . escape_and_echo($item['farm_id']) . '" aria-label="add to favorite">
                        ...
                        <div class="align-items-center d-flex justify-content-between">
                            <div class="pb-1 pt-1">
                                <span class="me-1 currentcolor">
                                    ' . generateStarRating($item['average_rating']) . '
                                </span>
                            ...
                            <span class="fw-bold pb-1 pt-1">From R' . escape_and_echo($item['min_price']) . '</span>
                        </div>
                    </div>                                         
                </div>                                     
            </div>
